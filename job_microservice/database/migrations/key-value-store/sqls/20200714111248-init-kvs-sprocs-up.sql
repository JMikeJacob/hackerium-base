...
BEGIN 
    ...
    SELECT hash_key INTO hashkey FROM job_kvs.hashes WHERE hash_key = p_key;
...
BEGIN
    ...
    FROM job_kvs.sorted_sets
    JOIN job_kvs.hashes ON sorted_sets.key = hashes.hash_key
