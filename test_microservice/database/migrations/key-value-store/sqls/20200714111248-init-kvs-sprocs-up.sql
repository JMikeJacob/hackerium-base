...
BEGIN 
    ...
    SELECT hash_key INTO hashkey FROM test_kvs.hashes WHERE hash_key = p_key;
...
BEGIN
    ...
    FROM test_kvs.sorted_sets
    JOIN test_kvs.hashes ON sorted_sets.key = hashes.hash_key
